...
for roomIndex% = 1 to 99
    itemRoom(roomIndex%) = 0 : roomVisited(roomIndex%) = 0
end for
...
for targetRoom% = 1 to 100
    ...
    roomExits(targetRoom%,1)=field1:roomExits(targetRoom%,2)=field2:roomExits(targetRoom%,3)=field3:roomExits(targetRoom%,4)=field4:roomExits(targetRoom%,5)=field5
    roomExits(targetRoom%,6)=field6:roomExits(targetRoom%,7)=field7:roomExits(targetRoom%,8)=field8:roomExits(targetRoom%,9)=field9:roomExits(targetRoom%,10)=field10
    PRINT ".";
end for
close #4
...
for targetRoom% = 1 to totalItems step 5
    read field1,field2,field3,field4,field5:itemRoom(targetRoom%)=field1:itemRoom(targetRoom%+1)=field2:itemRoom(targetRoom%+2)=field3:itemRoom(targetRoom%+3)=field4:itemRoom(targetRoom%+4)=field5
    PRINT ".";
end for
...
for itemPointsIndex% = 1 to 15 step 5
    read field1,field2,field3,field4,field5:itemPoints(itemPointsIndex%)=field1:itemPoints(itemPointsIndex%+1)=field2:itemPoints(itemPointsIndex%+2)=field3:itemPoints(itemPointsIndex%+3)=field4:itemPoints(itemPointsIndex%+4)=field5
    PRINT ".";
end for
data 1,2,2,2,2
data 3,4,3,3,2
