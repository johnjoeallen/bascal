...
BASIC**, not in designing new BASCAL source from scratch. Each of its eight
...
Eight stages take it from that unmodified original to fully structured
...
The complete port, all eight stages, is in
