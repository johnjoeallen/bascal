...
| `--target <t>`          | `-t`  | Backend to generate code for: `basic` (the original, complete backend), `c` (a mostly-complete native-C backend — see below), or `jvm` (a brand-new, bootstrap-stage native-JVM backend, just beginning — see below). Case-insensitive.                                                                                                                                                                                                                                                                 |
