...
Generated sources: [BCL](https://github.com/johnjoeallen/bascal/blob/main/tutorial/labels_and_error_handling.bcl) and [BASIC](https://github.com/johnjoeallen/bascal/blob/main/tutorial/labels_and_error_handling.bas).

This chapter covers labels and classic BASIC `ON ERROR GOTO`/`RESUME`. It is intentionally a BASIC-target tutorial: C and JVM programs should use the structured form in [Portable Structured Error Handling](portable_error_handling.md).
...
<summary><code>tutorial/labels_and_error_handling.bcl</code></summary>
...
<summary><code>tutorial/labels_and_error_handling.bas</code></summary>
...
880 IF (ERR = err_file_not_found) = 0 THEN GOTO 920
