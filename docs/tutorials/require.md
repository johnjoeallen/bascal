...
[← Screen I/O](screen.md)  ·  [Shared COMMON →](shared.md)
...
<summary><code>tutorial/require.bcl</code></summary>
...
<summary><code>tutorial/require.bas</code></summary>
