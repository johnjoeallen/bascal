...
I don't expect anyone to actually reach for BASCAL to ship a real application in 2026 — that was never really the point. It's a fun project: built mostly to see what's possible, and to relive an old frustration along the way.
