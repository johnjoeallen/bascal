...
descriptions = {
    ...
    "bare_dynamic_string_record_members_are_supported": "In-memory records support variable-length string fields",
    "bare_dynamic_string_record_is_rejected_as_file_type": "Variable-length string records are rejected as random-access file types",
