...
core_rows = {
    "core.random_file_binary_compatibility": ("Random file binary compatibility", {"basic": "PASS", "c": "PASS", "jvm": "FAIL"}),
    "core.all_tutorials_compile": ("All tutorial .bcl sources compile", {"basic": "PASS", "c": "PASS", "jvm": "DEFERRED"}),
    "core.deterministic_tutorials_execute": ("Deterministic tutorials build and execute", {"basic": "PASS", "c": "PASS", "jvm": "DEFERRED"}),
    "core.classic_error_handling_rejected": ("C/JVM reject the classic labels/error-handling tutorial", {"basic": "UNSUPPORTED", "c": "UNSUPPORTED", "jvm": "UNSUPPORTED"}),
    "core.inventory_case_study": ("Interactive inventory case study", {"basic": "PASS", "c": "PASS", "jvm": "DEFERRED"}),
    "core.builtin_scalar_methods": ("Built-in scalar method calls", {"basic": "PASS", "c": "PASS", "jvm": "PASS"}),
    "core.stdlib_functions": ("Standard-library function execution", {"basic": "PASS", "c": "PASS", "jvm": "PASS"}),
    "core.typed_arrays": ("Typed non-integer arrays and array parameters", {"basic": "DEFERRED", "c": "DEFERRED", "jvm": "PASS"}),
}
for test_id, (name, status) in core_rows.items():
    groups = ["core"]
    if test_id.endswith("random_file_binary_compatibility"):
        groups += ["basic", "c", "jvm", "files"]
    ids[test_id] = ("test", "core", name, groups, status)
