...
/// see `codegen_jvm`'s own module doc comment; it currently supports a small
/// straight-line subset. `main.rs`'s `--target` flag/`BASCAL_TARGET` env var/config files all
