...
210     PRINT ("Pass (" + STR$(score%)) + ")"
220     GOTO 240
230     PRINT ("Fail (" + STR$(score%)) + ")"
240 REM END IF
...
490         PRINT STR$(x%) + " is large and positive"
500         GOTO 520
510         PRINT STR$(x%) + " is small and positive"
520     REM END IF
530     GOTO 550
540     PRINT STR$(x%) + " is not positive"
550 REM END IF
